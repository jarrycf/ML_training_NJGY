...
from frames.medicalframe import dataProcess, trainModel, selectModel
from frames.widgets.iconButton import IconButton


class MedicalFrame(QMainWindow) :
    def __init__(self, parent=None) :
        super(MedicalFrame, self).__init__(parent)
        # 初始化数据
        self.init_data()
        # 设置窗口标题
        self.setWindowTitle("癌症诊断预测")
        # 设置窗口图标
